...
if (response){
  ...
  //H-O-N-E-Y-P-O-T !!
  validateForm(form) {
    var x = document.forms["contact-form bg-primary p-2"]["lastname"].value;
        ...
        {({ state }) => (
          <div className='contact-js top'>
            ...
            <div id='contact'>
              ...
              <Form action='https://hooks.zapier.com/hooks/catch/6694312/omo9b1g/' methos="POST" id='contactform' 
              ...
              Please do not hesitate to contact us directly.
                ...
                <div><label for='name'>Name</label>
                    <input
                      ...
                      required //Validation
                    />
                 <label for="lastname" className='lastname'>lsatname </label>
                    <input 
                    id="lastname" 
                    name="lastname" 
                    type="text" 
                ...
                <div><label for='message' >Message</label>
                  ...
                  type='submit'
                  disabled='disabled' validateForm={this.validateForm}/></div>
              ...
              {success && <div className='su' id='su'><h5>Thank you for contacting us! Our team will come back to you within a matter of hours to help you.</h5></div>}
        </div>
    )
  }}
            </Form>
