            ...
            <div className='jumbotron'>
              <div className='jumbo-left'>
                <img
                  className='jumbo-img'
                  src={img}
                  /*"https://images.unsplash.com/photo-1466637574441-749b8f19452f"*/ alt='Static-Image'
                />
              </div>
              ...
              <Carousel
                ...
                renderCenterLeftControls={({ previousSlide }) => (
                  <div onClick={previousSlide}>
                    <i class='carousel-button fas fa-chevron-circle-left'></i>
                  </div>
                )}
                renderCenterRightControls={({ nextSlide }) => (
                  <div onClick={nextSlide}>
                    <i class='carousel-button fas fa-chevron-circle-right'></i>
                  </div>
                )}>
                <img
